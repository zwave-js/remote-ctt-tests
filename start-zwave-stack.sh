...
./ZW_zwave_ncp_serial_api_controller_25_9_0_x86_REALTIME_DEBUG.elf --port 5000 --storage /tmp/controller1 &

echo "Starting Controller 2 (CTT) on port 5001..."
./ZW_zwave_ncp_serial_api_controller_25_9_0_x86_REALTIME_DEBUG.elf --port 5001 --storage /tmp/controller2 &

echo "Starting Controller 3 (CTT) on port 5002..."
./ZW_zwave_ncp_serial_api_controller_25_9_0_x86_REALTIME_DEBUG.elf --port 5002 --storage /tmp/controller3 &

# Start 2 end devices
echo "Starting End Device 1 on port 5003..."
./ZW_zwave_ncp_serial_api_end_device_25_9_0_x86_REALTIME_DEBUG.elf --port 5003 --storage /tmp/enddevice1 &

echo "Starting End Device 2 on port 5004..."
./ZW_zwave_ncp_serial_api_end_device_25_9_0_x86_REALTIME_DEBUG.elf --port 5004 --storage /tmp/enddevice2 &
